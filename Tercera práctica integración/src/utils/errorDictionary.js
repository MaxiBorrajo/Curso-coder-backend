...
export const errors = {
  ...
  NO_DOCUMENT_UPLOADED: NoDocumentUploadedError,
  INVALID_DOCUMENT_NAME_ERROR: InvalidDocumentNameError,
  MISSING_DOCUMENTATION_ERROR: MissingDocumentationError,
};
